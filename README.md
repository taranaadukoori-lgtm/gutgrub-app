...
- Add scripts to run the Express server in watch mode during development.
- Implement minimal mocked endpoints for `/register` and `/login-email` so the client forms behave end-to-end locally.
- Generate a small README badge matrix and example environment variables file.
